    ...
    <section id='services'>
      <div className='gridbox'>
        <li className='gridcell'>
          ...
          />
          <h3 className='service-heading'>Injury Rehabilitation</h3>
        ...
        <li className='gridcell'>
          <img
            ...
            src='https://cdn4.iconfinder.com/data/icons/oakcons-2/16/Image-512.png'
          />
          <h3 className='service-heading' >Sports Performance & Development</h3>
          <p>
        ...
        <li className='gridcell'>
          <img
            ...
            src='https://cdn4.iconfinder.com/data/icons/oakcons-2/16/Image-512.png'
          />
          <h3 className='service-heading' >Weight Loss</h3>
          <p>
        ...
        <li className='gridcell'>
          <img
            ...
            src='https://cdn4.iconfinder.com/data/icons/oakcons-2/16/Image-512.png'
          />
          <h3 className='service-heading' >Highly Valued Trainer-Client Relationship</h3>
          <p>
